			...
			<div class="table-responsive cart_info">
				<table class="table table-condensed">
                    ...
                    <tr>
                        ...
                        <td class="cart_total">
                            <p class="cart_total_price"><?php echo str_replace('$', '', $value['price']) * $value['qty']; ?></p>
                        </td>
