<?php
	...
	if(isset($_POST['submit'])){
		...
		if($x==1){
			 ...
			 $sql = "INSERT INTO product (title, price, image, id_user) 
			 VALUES(
			 '".$_POST['name_sanpham']."', 
            '".$_POST['price']."',
    		'".$_FILES['avatar']['name']."',
    			'".$id_ss."');";
				// bor id nguoi dung vao id_user vao
			if ($con->query($sql)) {
				...
				<div class="col-sm-9">
					<div class="blog-post-area">
						...
						<form action="#" method="POST" enctype="multipart/form-data">
							<input type="text" name="name_sanpham" placeholder="Name"/>
							<p><?php echo $err1;?></p>
							<input type="text" name="price"  placeholder="giá"/>
							<p><?php echo $err2;?></p>
							<input type="file" name="avatar" placeholder="img"/>
							<p><?php echo $err3;?></p>
